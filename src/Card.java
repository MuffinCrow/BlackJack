...
public class Card {
    ...
    public int getOrderedRank(String rank) {
        try {
            return Integer.parseInt(rank);
        } catch (NumberFormatException e) {
            switch (rank) {
                case "T": return 11;    // for 10s, Jacks, Queens, Kings,
                case "J": return 11;    // and Aces, we need to apply a
                case "Q": return 11;    // numeric value to simplify the
                case "K": return 11;    // sorting of hands and books.
                case "A": return 12;
            }
        }
    ...
    public int getOrderedSuit(String suit) {
        switch (suit) {
